...
|---|---|---|---|---|
| 2026-06-20 | bug | open | [update-close-leaves-unstaged-delete](./2026-06-20-update-close-leaves-unstaged-delete.md) | update skill の close フローで元 file の delete が commit に含まれない |
