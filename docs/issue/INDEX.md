...
| 2026-06-23 | bug | open | [read-skill-touches-frontmatter-keys-as-files](./2026-06-23-read-skill-touches-frontmatter-keys-as-files.md) | read skill が frontmatter キー名を cwd に空ファイルとして touch する事故 |
